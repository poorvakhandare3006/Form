...
if(mysqli_num_rows($result)>0){$valid=false;  $errorMsg=  "error : Mobile number already exists";}
...
<br><br>
      ...
      Password: <br> 
      <input  style="height:27px;color:#ffffff;font-size: 13pt;background: transparent;border: none;border-bottom: 2px solid #ADD8E6;width:380px "placeholder="Enter pass" id="number"  type="password" name="password" class ="form-control" > 
